...
@foreach ($data as $post )
    <tr>
        ...
        <td style="width: 40px;"><a href="/admin/users/{{$post->id}}/edit"><button class="btn btn-info">Edit</button></a></td>
...
<a href="/admin/users/create" class="btn btn-primary" >Create Users</a>
</body>
</html>
@endsection